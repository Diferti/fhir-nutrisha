...
export const HomePage = ({ patientInfo }: { patientInfo: any }) => {
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 pt-[30px] pb-[60px]">
      <div className="grid md:grid-cols-2 gap-8 mb-[60px]">
        <div className="bg-pageColor p-8 border border-primary rounded-[15px] shadow-[10px_10px_30px_0px_rgb(var(--shadow)/0.5)]">
          ...
          <ul className="space-y-4 text-primary font-fontMain font-extrabold">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-green-600 text-white rounded-lg flex items-center justify-center">1</div>
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-orange-600 text-white rounded-lg flex items-center justify-center">2</div>
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-blue-600 text-white rounded-lg flex items-center justify-center">3</div>
                </div>
                <div>
