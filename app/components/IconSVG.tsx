const iconHome = ({ color, width, height }) => (
    <svg width={width || "24"} height={height || "24"}  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M2 11L10.1259 4.49931C11.2216 3.62279 12.7784 3.62279 13.8741 4.49931L22 11" stroke={color}
              stroke-width="1.5" stroke-linecap="round"/>
        <path d="M15.5 5.5V3.5C15.5 3.22386 15.7239 3 16 3H18.5C18.7761 3 19 3.22386 19 3.5V8.5" stroke={color}
              stroke-width="1.5" stroke-linecap="round"/>
        <path d="M4 22V9.5" stroke={color} stroke-width="1.5" stroke-linecap="round"/>
        <path d="M20 22V9.5" stroke={color} stroke-width="1.5" stroke-linecap="round"/>
        <path
...
const iconDiet = ({color, width, height}) => (
    <svg width={width || "24"} height={height || "24"} viewBox="0 0 512.001 512.001" fill={color}
...
const iconAnalyze = ({color, width, height}) => (
    <svg width={width || "24"} height={height || "24"} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
        <path d="M27,16c0,0-4.9,7-11,7S5,16,5,16s4.9-7,11-7S27,16,27,16z" fill="none" stroke={color || "#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <circle cx="16" cy="16" r="3" fill="none" stroke={color || "#000000"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        {[
            ["3,9 3,3 9,3"],
            ["9,29 3,29 3,23"],
            ["29,23 29,29 23,29"],
            ...
            <polyline key={i} points={points} fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        ))}
    </svg>
);

export default function IconSVG({type, color, width, height}) {
    switch (type) {
        case 'home':
            return iconHome({color, width, height});
        case 'diet':
            return iconDiet({color, width, height});
        case 'analyze':
            return iconAnalyze({color, width, height});
        default:
            return null;
    }
}